...
{
	{
		StreamReader_t81027449065C1B0C339DB46241D8001A6F61130B* L_0 = __this->___standardOutput;
		if (L_0)
		{
			goto IL_0018;
		}
...
IL_0018:
	{
		int32_t L_3 = __this->___outputStreamReadMode;
		if (L_3)
		{
			goto IL_0029;
		}
	...
	{
		__this->___outputStreamReadMode = 1;
		goto IL_0042;
	}

IL_0029:
	{
		int32_t L_4 = __this->___outputStreamReadMode;
...
IL_005e:
	{
		...
		NullCheck(L_12);
		RuntimeObject* L_13;
		L_13 = InterfaceFuncInvoker0< RuntimeObject* >::Invoke(1, IDictionary_t6D03155AF1FA9083817AA5B6AD7DEEACC26AB220_il2cpp_TypeInfo_var, L_12);
		V_0 = L_13;
	}
	{
		auto __finallyBlock = il2cpp::utils::Finally([&]
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ProcessStartInfo_set_RedirectStandardInput_mD470F40F125D0FC08ED90014D259D82AEC493379 (ProcessStartInfo_t03E06D8098D3DC01CDACE23EE2D308BDA8E41D3C* __this, bool ___0_value, const RuntimeMethod* method) 
{
	{
		bool L_0 = ___0_value;
